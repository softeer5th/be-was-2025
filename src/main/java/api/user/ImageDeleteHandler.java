...
public class ImageDeleteHandler implements ApiHandler {
    @Override
    public boolean canHandle(HttpRequest httpRequest) {
        return "DELETE".equalsIgnoreCase(httpRequest.method())
    ...
    public LoadResult handle(HttpRequest httpRequest) {
        try {
            ...
            return createErrorResponse("SERVER-ERROR", "이미지 삭제 중 오류가 발생했습니다.");
        }
    }
